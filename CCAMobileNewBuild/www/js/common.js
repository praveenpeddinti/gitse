...
var serverURL = "http://10.10.73.62:8081/index.php/";
var site_base_ur = "http://10.10.73.62:8081/";
...
function openInChildBrowser(url){  
    inAppBrowser = cordova.InAppBrowser.open(url, '_blank', 'location=yes');
}
...
function sendViaEmail(){
    if(deviceAgent != "PC"){
        cordova.plugins.email.open({
            ...
            cc:      '',
            bcc:     [],
            subject: 'Share Clinic Details',
            body:    getClinicDetailsForEmail()
        });
